...
class File extends Field
{
    ...
    protected static $css = [
        '/assets/bootstrap-fileinput/css/fileinput.min.css?v=4.3.7',
    ];
     ...
     */
    protected static $js = [
        '/assets/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.7',
        '/assets/bootstrap-fileinput/js/fileinput.min.js?v=4.3.7',
    ];
